...
async def health_check_detailed() -> dict[str, Any]:
    ...
    try:
        ...
        except Exception as db_error:  # noqa: BLE001 - Health check should catch all exceptions
        ...
        try:
            if _container.auth_provider is not None:
                ...
                health_status["status"] = "degraded"
        except Exception as auth_error:  # noqa: BLE001 - Health check should catch all exceptions
