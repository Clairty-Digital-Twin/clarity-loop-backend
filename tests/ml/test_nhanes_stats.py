...
class TestNHANESStatsLookup:
    ...
    def test_lookup_norm_stats_default(self):
    ...
    def test_lookup_norm_stats_valid_year(self):
    ...
    def test_lookup_norm_stats_invalid_year(self):
    ...
    def test_lookup_norm_stats_with_age_group(self):
    ...
    def test_lookup_norm_stats_with_sex(self):
    ...
    def test_lookup_norm_stats_with_all_params(self):
    ...
    def test_lookup_norm_stats_invalid_age_group(self):
    ...
    def test_lookup_norm_stats_invalid_sex(self):
    ...
    def test_lookup_norm_stats_case_insensitive_sex(self):
...
class TestAvailableData:
    ...
    def test_get_available_age_groups(self):
    ...
    def test_available_data_consistency(self):
...
class TestReferenceInfo:
    ...
    def test_get_reference_info_valid_year(self):
    ...
    def test_get_reference_info_invalid_year(self):
    ...
    def test_get_reference_info_default(self):
...
class TestProxyValueValidation:
    ...
    def test_validate_proxy_values_normal(self):
    ...
    def test_validate_proxy_values_with_outliers(self):
...
class TestNHANESConstants:
    ...
    def test_extreme_outlier_threshold(self):
...
class TestNHANESStatsError:
    ...
    def test_nhanes_stats_error_creation(self):
    ...
    def test_lookup_with_empty_stats(self):
