...
class TestModalityProcessing:
    ...
    def test_convert_sleep_features_to_vector(self):
        ...
        result = HealthAnalysisPipeline._convert_sleep_features_to_vector(sleep_features)
...
class TestMainWorkflow:
    ...
    async def test_process_health_data_single_modality(self, mock_get_pat):
        ...
        with patch.object(pipeline.cardio_processor, 'process') as mock_cardio:
            ...
            assert result.fused_vector == [1.0, 2.0, 3.0]  # Single modality becomes fused vector
...
class TestSummaryStatistics:
    ...
    def test_generate_data_coverage(self):
        ...
        assert result["cardio"]["time_span_hours"] == 1.0  # Single timestamp defaults to 1.0
