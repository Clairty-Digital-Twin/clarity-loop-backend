...
class ModelChecksumManager:
    ...
    def calculate_file_checksum(self, file_path: Path) -> str:
        ...
        try:
            ...
            raise ModelIntegrityError(f"Error calculating checksum for {file_path}: {e}")

    def generate_model_manifest(self, model_name: str, model_files: list[str]) -> dict[str, Any]:
    ...
    def save_checksums(self, manifests: dict[str, dict[str, Any]]) -> None:
        ...
        try:
            ...
            logger.info(f"Saved checksums for {len(manifests)} models to {self.checksums_file}")
