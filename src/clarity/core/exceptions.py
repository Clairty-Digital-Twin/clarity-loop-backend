...
class DataLengthMismatchError(DataValidationError):
    ...
    def __init__(self, expected_length: int, actual_length: int, data_type: str = "data") -> None:
...
class InferenceError(ModelError):
    ...
    def __init__(self, message: str, *, request_id: str | None = None, **kwargs: Any) -> None:
...
class NHANESDataNotFoundError(NHANESStatsError):
    ...
    def __init__(self, year: int | None = None, age_group: str | None = None, sex: str | None = None) -> None:
        parts = []
        if year is not None:
...
class InvalidNHANESStatsDataError(NHANESStatsError):
    ...
    def __init__(self, data_type: str, expected_type: str, actual_type: str) -> None:
        message = f"Invalid NHANES {data_type}: expected {expected_type}, got {actual_type}"
        super().__init__(message)
        self.data_type = data_type
...
def create_validation_error(field_name: str, expected_type: str, actual_value: Any) -> DataValidationError:
...
def create_numeric_validation_error(field_name: str, value: Any) -> InvalidNHANESStatsDataError:
