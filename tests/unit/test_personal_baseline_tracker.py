...
class TestPersonalBaselineTracker:
    ...
    def create_health_metrics(self, days=28, base_date=None):
        ...
        for i in range(days):
            ...
            sleep_start = date.replace(hour=23, minute=0) - timedelta(hours=np.sin(i * 0.2))
    ...
    def test_calculate_deviation_scores(self):
        ...
        deviations = self.tracker.calculate_deviation_scores(self.user_id, normal_metrics)
    ...
    def test_calculate_deviation_extreme_values(self):
        ...
        deviations = self.tracker.calculate_deviation_scores(self.user_id, extreme_metrics)
    ...
    def test_circadian_shift_calculation(self):
        ...
        deviations = self.tracker.calculate_deviation_scores(self.user_id, early_metrics)
    ...
    def test_wraparound_handling(self):
        ...
        deviations = self.tracker.calculate_deviation_scores(self.user_id, late_night_metrics)
