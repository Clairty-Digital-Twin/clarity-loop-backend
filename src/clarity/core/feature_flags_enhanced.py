...
class EnhancedFeatureFlagManager(BaseFeatureFlagManager):
    ...
    def __init__(
        ...
        enhanced_config: Optional[EnhancedFeatureFlagConfig] = None,
    ) -> None:
    ...
    def _start_background_tasks(self) -> None:
        ...
        try:
            ...
            if self._enhanced_config.refresh_mode in (RefreshMode.PERIODIC, RefreshMode.BOTH):
    ...
    async def _pubsub_listener(self) -> None:
        ...
        while not self._shutdown_event.is_set():
            try:
                ...
                channel = (await self._redis_client.subscribe(
                    self._enhanced_config.pubsub_channel
                ))[0]
    ...
    async def _fetch_config_from_store(self) -> Optional[FeatureFlagConfig]:
        ...
        with self._lock:
            ...
            if self._last_refresh_time:
                ...
                if age > self._enhanced_config.stale_config_threshold_seconds:
                    ...
                    logger.warning(
                        "Feature flag configuration is stale, age=%ds", age
                    )
    ...
    def get_config_age_seconds(self) -> Optional[float]:
...
_enhanced_feature_flag_manager: Optional[EnhancedFeatureFlagManager] = None
