...
class CognitoAuthProvider(IAuthProvider):
    ...
    async def verify_token(self, token: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            if claims.get('aud') != self.client_id and claims.get('client_id') != self.client_id:
    ...
    async def update_user(self, uid: str, **kwargs) -> Optional[User]:
    ...
    async def authenticate(self, email: str, password: str) -> Optional[Dict[str, str]]:
        ...
        try:
            ...
            if 'ChallengeName' in response:
                logger.warning(f"Authentication challenge required: {response['ChallengeName']}")
                raise AuthenticationError(f"Challenge required: {response['ChallengeName']}")
