...
async def test_require_auth_no_user():
    ...
    @require_auth()
    async def dummy_endpoint(current_user: User | None = None):
        return "OK"
...
@pytest.mark.asyncio
async def test_require_auth_with_user():
...
@pytest.mark.asyncio
async def test_require_permission_with_user():
...
@pytest.mark.asyncio
async def test_require_role_with_user():
