...
class TestCircadianPhaseDetector:
    ...
    def test_insufficient_data(self):
        ...
        recent_metrics = [
            self.create_sleep_metric(datetime.now(UTC), 23, 7)
        ]
    ...
    def test_variable_sleep_pattern(self):
        ...
        recent_metrics = [
            self.create_sleep_metric(datetime.now(UTC) - timedelta(days=0), 20, 4),  # Very early
            self.create_sleep_metric(datetime.now(UTC) - timedelta(days=1), 2, 10),  # Very late
            self.create_sleep_metric(datetime.now(UTC) - timedelta(days=2), 22, 6),  # Normal
            self.create_sleep_metric(datetime.now(UTC) - timedelta(days=3), 21, 5),  # Early
            self.create_sleep_metric(datetime.now(UTC) - timedelta(days=4), 23, 7),  # Normal
            self.create_sleep_metric(datetime.now(UTC) - timedelta(days=5), 19, 3),  # Very early
            self.create_sleep_metric(datetime.now(UTC) - timedelta(days=6), 24, 8),  # Late
        ]
