        ...
        try:
            ...
            for i, char in enumerate(body_str[:100]):  # First 100 chars
                ...
                if i == 55:  # The problematic position
                    print(f"  ⚠️  POSITION 55 DETECTED!")
            ...
            try:
                ...
                if e.pos < len(body_str):
                    print(f"  Character at error position: '{body_str[e.pos]}' (ASCII: {ord(body_str[e.pos])})")
                ...
                return JSONResponse(
                    ...
                    content={
                        ...
                        "debug_info": {
                            ...
                            "error_context": body_str[max(0, e.pos-20):e.pos+20] if e.pos < len(body_str) else None
                        }
                    }
                )
