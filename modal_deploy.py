"""Modal deployment configuration for CLARITY backend."""
...
def fastapi_app() -> Any:
    ...
    from clarity.main import get_app       # noqa: E402
    return get_app()
...
def ping_credentials() -> Dict[str, Any]:
    ...
    # Print result for logging (allowed in test functions)  # noqa: T201
...
def test_app_startup() -> Dict[str, Any]:
    ...
    try:
        ...
        return {
            "status": "ERROR",
            "message": f"App initialization failed: {e!s}",
