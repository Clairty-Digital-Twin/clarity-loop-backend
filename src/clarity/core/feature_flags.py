...
class FeatureFlagManager:
    ...
    def _load_configuration(self) -> FeatureFlagConfig:
        ...
        default_flags = {
            ...
            "enhanced_security": FeatureFlag(
                ...
                status=FeatureFlagStatus.ENABLED if environment == "production" else FeatureFlagStatus.DISABLED,
    ...
    def is_enabled(
        ...
        try:
            ...
            if not flag:
                logger.warning(f"Unknown feature flag: {flag_name}, using default: {default}")
                return default
