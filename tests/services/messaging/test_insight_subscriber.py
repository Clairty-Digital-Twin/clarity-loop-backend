...
class TestProcessInsightRequest:
    ...
    @pytest.mark.asyncio
    async def test_process_insight_request_success(self, insight_subscriber, valid_pubsub_message):
    ...
    @pytest.mark.asyncio
    async def test_process_insight_request_production_auth(self, insight_subscriber, valid_pubsub_message):
...
class TestFastAPIEndpoints:
    ...
    @pytest.mark.asyncio
    async def test_process_insight_task_endpoint(self, test_client, valid_pubsub_message):
        """Test /process-task endpoint."""
        with patch("clarity.services.messaging.insight_subscriber.get_insight_subscriber") as mock_get:
