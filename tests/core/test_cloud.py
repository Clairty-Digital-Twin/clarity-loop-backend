...
class TestCloudModuleBoto3Integration:
    ...
    def test_get_aws_session_calls_boto3_session(self, mock_boto3_session):
    ...
    def test_get_cognito_client_calls_boto3_client(self, mock_boto3_client):
        ...
        mock_boto3_client.assert_called_once_with("cognito-idp", region_name="test-region")
        assert result == mock_client

    @patch('clarity.core.cloud.boto3.resource')
    def test_get_dynamodb_resource_calls_boto3_resource(self, mock_boto3_resource):
        ...
        mock_boto3_resource.assert_called_once_with("dynamodb", region_name="test-region")
