...
async def signup(auth_data: AuthRequest):
    ...
    try:
        ...
        if user:
            ...
            return AuthResponse(
                success=True, user_id=user.uid, email=user.email, tokens=tokens
            )
...
async def get_user_health_data(
    ...
    try:
        ...
        return {"success": True, "user_id": user_id, "data": items, "count": len(items)}
...
async def generate_insights(
    ...
    try:
        ...
        return {"success": True, "insight": response.text, "user_id": user_id}
