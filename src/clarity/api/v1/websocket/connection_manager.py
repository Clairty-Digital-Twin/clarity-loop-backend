...
class ConnectionManager:
    ...
    def __init__(
        ...
        self.user_connections: Dict[str, List[WebSocket]] = defaultdict(list)  # user_id -> [websockets]
        ...
        self.message_counts: Dict[str, List[float]] = defaultdict(list)  # user_id -> [timestamps]
    ...
    def _check_rate_limit(self, user_id: str) -> bool:
        ...
        recent_messages = [ts for ts in user_messages if current_time - ts < 60]
