...
class GeminiService:
    ...
    async def generate_health_insights(
        ...
        try:
            ...
            raise MLServiceError(f"Failed to generate insights: {str(e)}")
    ...
    async def analyze_pat_results(
        ...
        try:
            ...
            raise MLServiceError(f"Failed to analyze PAT results: {str(e)}")
    ...
    async def generate_recommendations(
        ...
        try:
            prompt = self._build_recommendations_prompt(user_profile, health_metrics, goals)
            ...
            raise MLServiceError(f"Failed to generate recommendations: {str(e)}")
