...
class TestMockAuthProviderComprehensive:
    ...
    @staticmethod
    def test_initialization_user_data_structure(mock_auth_provider: MockAuthProvider) -> None:
    ...
    @staticmethod
    async def test_verify_token_valid_dev_token_user(mock_auth_provider: MockAuthProvider) -> None:
    ...
    @staticmethod
    async def test_verify_token_valid_dev_token_admin(mock_auth_provider: MockAuthProvider) -> None:
    ...
    @staticmethod
    async def test_verify_token_valid_dev_token_patient(mock_auth_provider: MockAuthProvider) -> None:
    ...
    @staticmethod
    async def test_verify_token_valid_mock_token(mock_auth_provider: MockAuthProvider) -> None:
    ...
    @staticmethod
    async def test_verify_token_invalid_token(mock_auth_provider: MockAuthProvider) -> None:
    ...
    @staticmethod
    async def test_verify_token_empty_string(mock_auth_provider: MockAuthProvider) -> None:
    ...
    @staticmethod
    async def test_verify_token_whitespace(mock_auth_provider: MockAuthProvider) -> None:
    ...
    @staticmethod
    async def test_verify_token_case_sensitive(mock_auth_provider: MockAuthProvider) -> None:
    ...
    @staticmethod
    async def test_verify_token_returns_copy(mock_auth_provider: MockAuthProvider) -> None:
    ...
    @staticmethod
    async def test_get_user_info_valid_user_id(mock_auth_provider: MockAuthProvider) -> None:
    ...
    @staticmethod
    async def test_get_user_info_admin_user(mock_auth_provider: MockAuthProvider) -> None:
    ...
    @staticmethod
    async def test_get_user_info_patient_user(mock_auth_provider: MockAuthProvider) -> None:
    ...
    @staticmethod
    async def test_get_user_info_invalid_user_id(mock_auth_provider: MockAuthProvider) -> None:
    ...
    @staticmethod
    async def test_get_user_info_empty_string(mock_auth_provider: MockAuthProvider) -> None:
    ...
    @staticmethod
    async def test_get_user_info_returns_copy(mock_auth_provider: MockAuthProvider) -> None:
    ...
    @staticmethod
    def test_create_mock_token_test_patient(mock_auth_provider: MockAuthProvider) -> None:
    ...
    @staticmethod
    def test_create_mock_token_default_user(mock_auth_provider: MockAuthProvider) -> None:
    ...
    @staticmethod
    def test_create_mock_token_unknown_user(mock_auth_provider: MockAuthProvider) -> None:
    ...
    @staticmethod
    def test_create_mock_token_empty_string(mock_auth_provider: MockAuthProvider) -> None:
    ...
    @staticmethod
    def test_get_available_mock_users_structure(mock_auth_provider: MockAuthProvider) -> None:
    ...
    @staticmethod
    def test_get_available_mock_users_returns_copy(mock_auth_provider: MockAuthProvider) -> None:
    ...
    @staticmethod
    async def test_integration_verify_then_get_user_info(mock_auth_provider: MockAuthProvider) -> None:
    ...
    @staticmethod
    async def test_integration_create_token_then_verify(mock_auth_provider: MockAuthProvider) -> None:
    ...
    @staticmethod
    async def test_mock_users_immutability(mock_auth_provider: MockAuthProvider) -> None:
    ...
    @staticmethod
    async def test_all_token_types_map_to_valid_users(mock_auth_provider: MockAuthProvider) -> None:
    ...
    @staticmethod
    async def test_user_roles_are_correctly_assigned(mock_auth_provider: MockAuthProvider) -> None:
