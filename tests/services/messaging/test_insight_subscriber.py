...
class TestInsightSubscriberInit:
    ...
    def test_init_default(
        ...
        with patch.dict("os.environ", {}, clear=True):
            ...
            # The actual behavior depends on whether credentials are available
            # In test environment, storage_client may or may not be initialized
            # Gemini service should be created
            assert subscriber.gemini_service is not None
